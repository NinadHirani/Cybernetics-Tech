            ...
            <div className="w-full lg:w-6/12 px-[15px]">
              <div className="lg:pl-8">
                ...
                <p className="text-slate-400 text-[16px] leading-[1.6] mb-8 font-body">
                  With over 12 years of experience and a track record of 1500+ successful projects, our team of expert developers and designers is committed to helping businesses grow through innovative technology and creative excellence.
                </p>
                <div className="grid grid-cols-2 gap-6">
                  <div className="p-4 rounded-lg bg-card border border-white/5">
                    <h4 className="text-white font-bold text-[20px] mb-1">12+ Years</h4>
